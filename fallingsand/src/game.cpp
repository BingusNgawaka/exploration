...
void PixelTexture::setPixel(int x, int y, Color& c){
...
Color PixelTexture::getPixelColor(int x, int y){
    int convertedIndex {y*width + x};
    return Color{pixelArray[convertedIndex].r,pixelArray[convertedIndex].g,pixelArray[convertedIndex].b,pixelArray[convertedIndex].a};
}
